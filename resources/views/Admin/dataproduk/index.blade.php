            ...
            <div class="grid grid-cols-2 gap-3">
                ...
                <div class="mb-3">
                    ...
                    <div id="currentImageContainer" class="mb-2 hidden">
                        ...
                        <img id="currentImage" src="#" alt="Current image" class="w-20 h-20 object-cover rounded-lg border">
                        <button type="button" onclick="removeCurrentImage()" class="text-xs text-red-500 mt-1">Hapus gambar</button>
                    </div>
...
<script>
    ...
    function removeCurrentImage() {
        ...
        const oldInput = editForm.querySelector('input[name="remove_image"]');
