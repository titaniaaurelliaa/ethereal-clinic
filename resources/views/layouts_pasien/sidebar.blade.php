<aside id="desktopSidebar" class="hidden md:flex flex-col w-64 bg-white border-r border-[#E1E3DE]/60 h-screen sticky top-0 transition-all duration-300 relative z-40 shrink-0">
    ...
    <nav class="flex-1 py-4 px-4 space-y-2 overflow-y-auto hide-scrollbar">
        ...
        <a href="{{ route('analisis.index') }}" class="flex items-center px-3 py-3 rounded-xl transition-colors group {{ request()->routeIs('analisis.*') ? 'bg-[#FFEFF3] text-[#7B5556] font-semibold' : 'text-[#797B78] hover:bg-[#F5F5F5] hover:text-[#5D605C] font-medium' }}" title="Konsultasi">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <a href="{{ route('pasien.history') }}" class="flex items-center px-3 py-3 rounded-xl transition-colors group {{ request()->routeIs('pasien.history') ? 'bg-[#FFEFF3] text-[#7B5556] font-semibold' : 'text-[#797B78] hover:bg-[#F5F5F5] hover:text-[#5D605C] font-medium' }}" title="Riwayat">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
