<aside id="desktopSidebar"
    ...
    <nav class="flex-1 py-4 px-4 space-y-2 overflow-y-auto">
        ...
        <!-- Data Gejala (Symptom Rules) -->
        <a href="{{ route('admin.symptom-rules.index') }}"
            class="flex items-center px-3 py-3 rounded-xl transition-colors group {{ request()->routeIs('admin.symptom-rules*') ? 'bg-[#FFEFF3] text-[#7B5556] font-semibold' : 'text-[#797B78] hover:bg-[#F5F5F5] hover:text-[#5D605C] font-medium' }}"
            title="Data Gejala">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24"
                stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <span class="ml-3 whitespace-nowrap sidebar-text">Data Pertanyaan</span>
        </a>
        ...
        <a href="{{ route('admin.news.index') }}"
            ...
            <span class="ml-3 whitespace-nowrap sidebar-text">Manajemen Berita</span>
        </a>
