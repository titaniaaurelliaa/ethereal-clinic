<aside id="desktopSidebar" class="flex flex-col w-64 bg-white border-r border-[#E1E3DE]/60 min-h-screen transition-all duration-300 relative z-40 shrink-0">
    ...
    <div class="h-20 flex items-center justify-center border-b border-[#E1E3DE]/40 px-4 overflow-hidden">
        <a href="{{ route('admin.dashboard') }}" class="text-xl font-extrabold text-[#7B5556] tracking-tight whitespace-nowrap" id="sidebarLogo">
            The Ethereal Clinic
        </a>
        <a href="{{ route('admin.dashboard') }}" class="hidden text-xl font-extrabold text-[#7B5556] tracking-tight" id="sidebarLogoMini">
            TEC
        </a>
    </div>
    ...
    <div class="py-6 border-b border-[#E1E3DE]/30 overflow-hidden">
        <div class="flex items-center px-4">
            <div class="w-12 h-12 rounded-full overflow-hidden border-2 border-[#7B5556]/20 shrink-0 shadow-sm bg-white">
                <img src="{{ Auth::user()->avatar ? asset('storage/avatars/' . Auth::user()->avatar) : 'https://ui-avatars.com/api/?name=' . urlencode(Auth::user()->name ?? 'Admin') . '&background=68575E&color=fff' }}" alt="Profile" class="w-full h-full object-cover">
            </div>
            <div class="ml-3 sidebar-text whitespace-nowrap">
                <p class="text-base font-bold text-[#5D605C]">{{ Auth::user() ? explode(' ', Auth::user()->name)[0] : 'Admin' }}</p>
    ...
    <nav class="flex-1 py-4 px-4 space-y-2 overflow-y-auto">
        <!-- Dashboard -->
        <a href="{{ route('admin.dashboard') }}" class="flex items-center px-3 py-3 rounded-xl transition-colors group {{ request()->routeIs('admin.dashboard') ? 'bg-[#FFEFF3] text-[#7B5556] font-semibold' : 'text-[#797B78] hover:bg-[#F5F5F5] hover:text-[#5D605C] font-medium' }}" title="Dashboard">
        ...
        <!-- Data Gejala -->
        <a href="#" class="flex items-center px-3 py-3 rounded-xl transition-colors group text-[#797B78] hover:bg-[#F5F5F5] hover:text-[#5D605C] font-medium" title="Data Gejala">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <!-- Data Produk -->
        <a href="#" class="flex items-center px-3 py-3 rounded-xl transition-colors group text-[#797B78] hover:bg-[#F5F5F5] hover:text-[#5D605C] font-medium" title="Data Produk">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <!-- Data Treatment -->
        <a href="#" class="flex items-center px-3 py-3 rounded-xl transition-colors group text-[#797B78] hover:bg-[#F5F5F5] hover:text-[#5D605C] font-medium" title="Data Treatment">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <!-- Rule + CF Pakar -->
        <a href="#" class="flex items-center px-3 py-3 rounded-xl transition-colors group text-[#797B78] hover:bg-[#F5F5F5] hover:text-[#5D605C] font-medium" title="Rule & CF Pakar">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <!-- Riwayat Analisis -->
        <a href="#" class="flex items-center px-3 py-3 rounded-xl transition-colors group text-[#797B78] hover:bg-[#F5F5F5] hover:text-[#5D605C] font-medium" title="Riwayat Analisis">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <!-- Profile Admin -->
        <a href="{{ route('admin.profile') }}" class="flex items-center px-3 py-3 rounded-xl transition-colors group {{ request()->routeIs('admin.profile*') ? 'bg-[#FFEFF3] text-[#7B5556] font-semibold' : 'text-[#797B78] hover:bg-[#F5F5F5] hover:text-[#5D605C] font-medium' }}" title="Profile">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
