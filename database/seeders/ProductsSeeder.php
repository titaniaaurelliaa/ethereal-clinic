    ...
    public function run(): void
    {
        $products = [
            ...
            [
                ...
                'image_path' => 'products/avoskin-salicylic.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'image_path' => 'products/emina-spot-treatment.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'image_path' => 'products/anua-azelaic.png',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            ...
            [
                ...
                'image_path' => 'products/skintific-hydrating.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'image_path' => 'products/wardah-cleansing-milk.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            ...
            [
                ...
                'image_path' => 'products/originote-niacinamide.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'image_path' => 'products/garnier-oil-control.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            ...
            [
                ...
                'image_path' => 'products/paulas-choice-bha.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'image_path' => 'products/pimplo-pore-strip.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            ...
            [
                ...
                'image_path' => 'products/azarine-cica.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            ...
            [
                ...
                'image_path' => 'products/luxcrime-vitc.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            ...
            [
                ...
                'image_path' => 'products/skinaqua-sunscreen.jpg',
                'created_at' => now(),
                'updated_at' => now(),
            ],
        ];
